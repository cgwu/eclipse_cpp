...
namespace Assergs.Windows
{
    ...
    public static class ToolWindowTabItemContainerPallet
    {
        #region Declare
        ...
        static ToolWindowTabItemContainerPallet()
        {
            ToolWindowTabItemContainerPallet.Reset();
            OfficeColors.RegistersTypes.Add(typeof(ToolWindowTabItemContainerPallet));
        }
        ...
        public static void Reset()
        {
            ...
            Glyph = OfficeColors.Foreground.OfficeColor2;
