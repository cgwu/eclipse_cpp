...
{
	#region DropDownHeaderButtonPallet

	public static class DropDownHeaderButtonPallet
    {
        #region Declare
		...
		public static Color LightButtonBackGroundBrush1;
		public static Color LightButtonBackGroundBrush2;
		...
		static DropDownHeaderButtonPallet()
        {
			DropDownHeaderButtonPallet.Reset();
			OfficeColors.RegistersTypes.Add(typeof(DropDownHeaderButtonPallet));
        }
        ...
        public static void Reset()
        {
			...
			LightButtonBackGroundBrush1 = OfficeColors.HighLight.OfficeColor22;
			LightButtonBackGroundBrush2 = OfficeColors.HighLight.OfficeColor23;
