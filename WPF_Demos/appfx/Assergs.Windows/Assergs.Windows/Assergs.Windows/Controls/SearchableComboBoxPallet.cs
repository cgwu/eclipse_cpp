...
{
    #region SearchableComboBoxPallet

    public static class SearchableComboBoxPallet
    {
        #region Declare
		...
		static SearchableComboBoxPallet()
        {
			SearchableComboBoxPallet.Reset();
			OfficeColors.RegistersTypes.Add(typeof(SearchableComboBoxPallet));
        }
