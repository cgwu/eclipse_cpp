...
namespace RoutedEventDemo
{
    ...
    public class ThemeSwitcher
    {
        ...
        public static void SwitchTheme(ThemeEnum theme)
        {
            Application.Current.Resources.MergedDictionaries.Add(GetThemeResourceDictionary(theme));
        ...
        public static void UnloadTheme(ThemeEnum theme)
        {
            Application.Current.Resources.MergedDictionaries.Remove(GetThemeResourceDictionary(theme));
